...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "[",     function ()
	    awful.util.spawn("./scripts/keyboard_dvorak.sh") end,
	    	{description = "change dvorak", group = "launcher"}),
		
    awful.key({ modkey },            "]",     function ()
	    awful.util.spawn("./scripts/keyboard_dvorak-intl.sh") end,
	    	{description = "change dvorak-intl", group = "launcher"}),

    awful.key({ modkey },            "\\",     function ()
	    awful.util.spawn("./scripts/keyboard_qwerty.sh") end,
	    	{description = "change qwerty", group = "launcher"}),
...
awful.spawn.with_shell("$HOME/scripts/mouse_script.sh")
awful.spawn.with_shell("$HOME/scripts/keyboard_dvorak.sh")

awful.spawn.with_shell("/usr/bin/emacs --daemon")

awful.spawn.with_shell("/usr/bin/pipewire &")
awful.spawn.with_shell("/usr/bin/pipewire-pulse &")
awful.spawn.with_shell("/usr/bin/pipewire-media-session &")
...
awful.spawn.with_shell("youtube-music-desktop-app")
